...
namespace BankClient.BANKDataSetTableAdapters {
...
SELECT id_BankAccount, AccountNumber, Amount, OpeningDate, id_client FROM BankAccount WHERE (id_BankAccount = @id_BankAccount)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::BankClient.Properties.Settings.Default.BANKConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[1].CommandText = "INSERT INTO [dbo].[BankAccount] ([AccountNumber], [Amount], [OpeningDate], [id_cl" +
                "ient]) VALUES (@AccountNumber, @Amount, @OpeningDate, @id_client);\r\n";
            this._commandCollection[1].CommandType = global::System.Data.CommandType.Text;
            this._commandCollection[1].Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@AccountNumber", global::System.Data.SqlDbType.VarChar, 16, global::System.Data.ParameterDirection.Input, 0, 0, "AccountNumber", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
            ...
            this._commandCollection[1].Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@OpeningDate", global::System.Data.SqlDbType.DateTime, 8, global::System.Data.ParameterDirection.Input, 0, 0, "OpeningDate", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
            ...
            this._commandCollection[2].CommandText = "UPDATE [dbo].[BankAccount] SET [AccountNumber] = @AccountNumber, [Amount] = @Amou" +
                "nt, [OpeningDate] = @OpeningDate, [id_client] = @id_client WHERE (([id_BankAccou" +
                "nt] = @Original_id_BankAccount));\r\n";
            this._commandCollection[2].CommandType = global::System.Data.CommandType.Text;
            this._commandCollection[2].Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@AccountNumber", global::System.Data.SqlDbType.VarChar, 16, global::System.Data.ParameterDirection.Input, 0, 0, "AccountNumber", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
            ...
            this._commandCollection[2].Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@OpeningDate", global::System.Data.SqlDbType.DateTime, 8, global::System.Data.ParameterDirection.Input, 0, 0, "OpeningDate", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
            ...
            this._commandCollection[2].Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@Original_id_BankAccount", global::System.Data.SqlDbType.Int, 4, global::System.Data.ParameterDirection.Input, 0, 0, "id_BankAccount", global::System.Data.DataRowVersion.Original, false, null, "", "", ""));
        }
        ...
        public virtual int InsertQuery(string AccountNumber, double Amount, System.DateTime OpeningDate, int id_client) {
            global::System.Data.SqlClient.SqlCommand command = this.CommandCollection[1];
            if ((AccountNumber == null)) {
                throw new global::System.ArgumentNullException("AccountNumber");
            }
            else {
                command.Parameters[0].Value = ((string)(AccountNumber));
            }
            command.Parameters[1].Value = ((double)(Amount));
            command.Parameters[2].Value = ((System.DateTime)(OpeningDate));
        ...
        public virtual int UpdateQuery(string AccountNumber, double Amount, System.DateTime OpeningDate, int id_client, int Original_id_BankAccount) {
            ...
            command.Parameters[2].Value = ((System.DateTime)(OpeningDate));
            command.Parameters[3].Value = ((int)(id_client));
            command.Parameters[4].Value = ((int)(Original_id_BankAccount));
            global::System.Data.ConnectionState previousConnectionState = command.Connection.State;
            if (((command.Connection.State & global::System.Data.ConnectionState.Open) 
                        != global::System.Data.ConnectionState.Open)) {
                command.Connection.Open();
...
SELECT id_client, Pincode, UserName, UserSurname, UserPatronymic, PassportData, DateOfBirth FROM Client WHERE (id_client = @id_client)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[1] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[1].Connection = this.Connection;
            this._commandCollection[1].CommandText = "INSERT INTO [dbo].[Client] ([Pincode], [UserName], [UserSurname], [UserPatronymic" +
                "], [PassportData], [DateOfBirth]) VALUES (@Pincode, @UserName, @UserSurname, @Us" +
                "erPatronymic, @PassportData, @DateOfBirth);\r\n";
            this._commandCollection[1].CommandType = global::System.Data.CommandType.Text;
            this._commandCollection[1].Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@Pincode", global::System.Data.SqlDbType.VarChar, 4, global::System.Data.ParameterDirection.Input, 0, 0, "Pincode", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
            ...
            this._commandCollection[1].Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@UserSurname", global::System.Data.SqlDbType.VarChar, 20, global::System.Data.ParameterDirection.Input, 0, 0, "UserSurname", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
            this._commandCollection[1].Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@UserPatronymic", global::System.Data.SqlDbType.VarChar, 20, global::System.Data.ParameterDirection.Input, 0, 0, "UserPatronymic", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
            this._commandCollection[1].Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@PassportData", global::System.Data.SqlDbType.VarChar, 10, global::System.Data.ParameterDirection.Input, 0, 0, "PassportData", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
            ...
            this._commandCollection[2] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[2].Connection = this.Connection;
            this._commandCollection[2].CommandText = "UPDATE [dbo].[Client] SET [Pincode] = @Pincode, [UserName] = @UserName, [UserSurn" +
                "ame] = @UserSurname, [UserPatronymic] = @UserPatronymic, [PassportData] = @Passp" +
                "ortData, [DateOfBirth] = @DateOfBirth WHERE (([id_client] = @Original_id_client)" +
                ");\r\n";
            this._commandCollection[2].CommandType = global::System.Data.CommandType.Text;
            this._commandCollection[2].Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@Pincode", global::System.Data.SqlDbType.VarChar, 4, global::System.Data.ParameterDirection.Input, 0, 0, "Pincode", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
            ...
            this._commandCollection[2].Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@UserSurname", global::System.Data.SqlDbType.VarChar, 20, global::System.Data.ParameterDirection.Input, 0, 0, "UserSurname", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
            this._commandCollection[2].Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@UserPatronymic", global::System.Data.SqlDbType.VarChar, 20, global::System.Data.ParameterDirection.Input, 0, 0, "UserPatronymic", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
            this._commandCollection[2].Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@PassportData", global::System.Data.SqlDbType.VarChar, 10, global::System.Data.ParameterDirection.Input, 0, 0, "PassportData", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Insert, false)]
        public virtual int InsertQuery(string Pincode, string UserName, string UserSurname, string UserPatronymic, string PassportData, System.DateTime DateOfBirth) {
            global::System.Data.SqlClient.SqlCommand command = this.CommandCollection[1];
            if ((Pincode == null)) {
                throw new global::System.ArgumentNullException("Pincode");
            }
            else {
                command.Parameters[0].Value = ((string)(Pincode));
            }
            if ((UserName == null)) {
                throw new global::System.ArgumentNullException("UserName");
            }
            ...
            if ((UserPatronymic == null)) {
                ...
                command.Parameters[3].Value = ((string)(UserPatronymic));
            }
            if ((PassportData == null)) {
                throw new global::System.ArgumentNullException("PassportData");
            }
            else {
                command.Parameters[4].Value = ((string)(PassportData));
            }
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, false)]
        public virtual int UpdateQuery(string Pincode, string UserName, string UserSurname, string UserPatronymic, string PassportData, System.DateTime DateOfBirth, int Original_id_client) {
            global::System.Data.SqlClient.SqlCommand command = this.CommandCollection[2];
            if ((Pincode == null)) {
                throw new global::System.ArgumentNullException("Pincode");
            }
...
SELECT id_CreditData, AmountCredit, id_client, CreditInterest, LoanRepaymentByMonth, DebtBalance, OpeningDate, ClosingDate, Status, id_BankAccount FROM CreditData WHERE (id_CreditData = @id_CreditData)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[1] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[1].Connection = this.Connection;
            this._commandCollection[1].CommandText = @"INSERT INTO [dbo].[CreditData] ([AmountCredit], [id_client], [CreditInterest], [LoanRepaymentByMonth], [DebtBalance], [OpeningDate], [ClosingDate], [Status], [id_BankAccount]) VALUES (@AmountCredit, @id_client, @CreditInterest, @LoanRepaymentByMonth, @DebtBalance, @OpeningDate, @ClosingDate, @Status, @id_BankAccount);
";
            this._commandCollection[1].CommandType = global::System.Data.CommandType.Text;
            this._commandCollection[1].Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@AmountCredit", global::System.Data.SqlDbType.Int, 4, global::System.Data.ParameterDirection.Input, 0, 0, "AmountCredit", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
            this._commandCollection[1].Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@id_client", global::System.Data.SqlDbType.Int, 4, global::System.Data.ParameterDirection.Input, 0, 0, "id_client", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
            this._commandCollection[1].Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@CreditInterest", global::System.Data.SqlDbType.Decimal, 5, global::System.Data.ParameterDirection.Input, 2, 2, "CreditInterest", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
            this._commandCollection[1].Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@LoanRepaymentByMonth", global::System.Data.SqlDbType.Float, 8, global::System.Data.ParameterDirection.Input, 0, 0, "LoanRepaymentByMonth", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
            this._commandCollection[1].Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@DebtBalance", global::System.Data.SqlDbType.Float, 8, global::System.Data.ParameterDirection.Input, 0, 0, "DebtBalance", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
            this._commandCollection[1].Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@OpeningDate", global::System.Data.SqlDbType.DateTime, 8, global::System.Data.ParameterDirection.Input, 0, 0, "OpeningDate", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
            ...
            this._commandCollection[1].Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@id_BankAccount", global::System.Data.SqlDbType.Int, 4, global::System.Data.ParameterDirection.Input, 0, 0, "id_BankAccount", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
        }
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Insert, false)]
        public virtual int InsertQuery(int AmountCredit, int id_client, decimal CreditInterest, double LoanRepaymentByMonth, double DebtBalance, System.DateTime OpeningDate, global::System.Nullable<global::System.DateTime> ClosingDate, string Status, int id_BankAccount) {
            global::System.Data.SqlClient.SqlCommand command = this.CommandCollection[1];
            command.Parameters[0].Value = ((int)(AmountCredit));
            command.Parameters[1].Value = ((int)(id_client));
            command.Parameters[2].Value = ((decimal)(CreditInterest));
            command.Parameters[3].Value = ((double)(LoanRepaymentByMonth));
            command.Parameters[4].Value = ((double)(DebtBalance));
            command.Parameters[5].Value = ((System.DateTime)(OpeningDate));
            if ((ClosingDate.HasValue == true)) {
                command.Parameters[6].Value = ((System.DateTime)(ClosingDate.Value));
            }
            else {
            ...
            command.Parameters[8].Value = ((int)(id_BankAccount));
            global::System.Data.ConnectionState previousConnectionState = command.Connection.State;
            if (((command.Connection.State & global::System.Data.ConnectionState.Open) 
                        != global::System.Data.ConnectionState.Open)) {
                command.Connection.Open();
...
SELECT id_DebitCard, CardNumber, CVV, CardValidityPeriod, PinCode, State, id_bankAccount FROM DebitCard WHERE (id_DebitCard = @id_DebitCard)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[1] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[1].Connection = this.Connection;
            this._commandCollection[1].CommandText = "INSERT INTO [dbo].[DebitCard] ([CardNumber], [CVV], [CardValidityPeriod], [PinCod" +
                "e], [State], [id_bankAccount]) VALUES (@CardNumber, @CVV, @CardValidityPeriod, @" +
                "PinCode, @State, @id_bankAccount);\r\n";
            this._commandCollection[1].CommandType = global::System.Data.CommandType.Text;
            this._commandCollection[1].Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@CardNumber", global::System.Data.SqlDbType.VarChar, 16, global::System.Data.ParameterDirection.Input, 0, 0, "CardNumber", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
            this._commandCollection[1].Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@CVV", global::System.Data.SqlDbType.VarChar, 3, global::System.Data.ParameterDirection.Input, 0, 0, "CVV", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
            this._commandCollection[1].Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@CardValidityPeriod", global::System.Data.SqlDbType.DateTime, 8, global::System.Data.ParameterDirection.Input, 0, 0, "CardValidityPeriod", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
            this._commandCollection[1].Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@PinCode", global::System.Data.SqlDbType.VarChar, 4, global::System.Data.ParameterDirection.Input, 0, 0, "PinCode", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
            this._commandCollection[1].Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@State", global::System.Data.SqlDbType.VarChar, 20, global::System.Data.ParameterDirection.Input, 0, 0, "State", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
            this._commandCollection[1].Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@id_bankAccount", global::System.Data.SqlDbType.Int, 4, global::System.Data.ParameterDirection.Input, 0, 0, "id_bankAccount", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
            this._commandCollection[2] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[2].Connection = this.Connection;
            this._commandCollection[2].CommandText = "UPDATE [dbo].[DebitCard] SET [State] = @State WHERE (([CardNumber] = @Original_Ca" +
                "rdNumber));\r\n";
            this._commandCollection[2].CommandType = global::System.Data.CommandType.Text;
            this._commandCollection[2].Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@State", global::System.Data.SqlDbType.VarChar, 20, global::System.Data.ParameterDirection.Input, 0, 0, "State", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
            this._commandCollection[2].Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@Original_CardNumber", global::System.Data.SqlDbType.VarChar, 16, global::System.Data.ParameterDirection.Input, 0, 0, "CardNumber", global::System.Data.DataRowVersion.Original, false, null, "", "", ""));
        }
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Insert, false)]
        public virtual int InsertQuery(string CardNumber, string CVV, System.DateTime CardValidityPeriod, string PinCode, string State, int id_bankAccount) {
            global::System.Data.SqlClient.SqlCommand command = this.CommandCollection[1];
            if ((CardNumber == null)) {
                throw new global::System.ArgumentNullException("CardNumber");
            }
            ...
            if ((CVV == null)) {
                ...
                command.Parameters[1].Value = ((string)(CVV));
            }
            command.Parameters[2].Value = ((System.DateTime)(CardValidityPeriod));
            if ((PinCode == null)) {
                throw new global::System.ArgumentNullException("PinCode");
            }
            else {
                command.Parameters[3].Value = ((string)(PinCode));
            }
            if ((State == null)) {
                throw new global::System.ArgumentNullException("State");
            }
            ...
            command.Parameters[5].Value = ((int)(id_bankAccount));
            global::System.Data.ConnectionState previousConnectionState = command.Connection.State;
            if (((command.Connection.State & global::System.Data.ConnectionState.Open) 
                        != global::System.Data.ConnectionState.Open)) {
                command.Connection.Open();
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, false)]
        public virtual int UpdateQuery(string State, string Original_CardNumber) {
            global::System.Data.SqlClient.SqlCommand command = this.CommandCollection[2];
            if ((State == null)) {
                throw new global::System.ArgumentNullException("State");
            }
...
SELECT id_FinanceOperations, id_BankAccount, OperationType, DATE, id_contactBankAccount, OperationsStatus, Balance FROM FinanceOperations WHERE (id_FinanceOperations = @id_FinanceOperations)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[1] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[1].Connection = this.Connection;
            this._commandCollection[1].CommandText = "INSERT INTO [dbo].[FinanceOperations] ([id_BankAccount], [OperationType], [DATE]," +
                " [id_contactBankAccount], [OperationsStatus], [Balance]) VALUES (@id_BankAccount" +
                ", @OperationType, @DATE, @id_contactBankAccount, @OperationsStatus, @Balance);\r\n" +
                "";
            this._commandCollection[1].CommandType = global::System.Data.CommandType.Text;
            this._commandCollection[1].Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@id_BankAccount", global::System.Data.SqlDbType.Int, 4, global::System.Data.ParameterDirection.Input, 0, 0, "id_BankAccount", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
            this._commandCollection[1].Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@OperationType", global::System.Data.SqlDbType.VarChar, 20, global::System.Data.ParameterDirection.Input, 0, 0, "OperationType", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
            ...
            this._commandCollection[1].Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@id_contactBankAccount", global::System.Data.SqlDbType.Int, 4, global::System.Data.ParameterDirection.Input, 0, 0, "id_contactBankAccount", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
            this._commandCollection[1].Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@OperationsStatus", global::System.Data.SqlDbType.VarChar, 20, global::System.Data.ParameterDirection.Input, 0, 0, "OperationsStatus", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
            this._commandCollection[1].Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@Balance", global::System.Data.SqlDbType.Float, 8, global::System.Data.ParameterDirection.Input, 0, 0, "Balance", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
        }
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Insert, false)]
        public virtual int InsertQuery(int id_BankAccount, string OperationType, System.DateTime DATE, int id_contactBankAccount, string OperationsStatus, double Balance) {
            global::System.Data.SqlClient.SqlCommand command = this.CommandCollection[1];
            command.Parameters[0].Value = ((int)(id_BankAccount));
            if ((OperationType == null)) {
                throw new global::System.ArgumentNullException("OperationType");
            }
            else {
                command.Parameters[1].Value = ((string)(OperationType));
            }
            command.Parameters[2].Value = ((System.DateTime)(DATE));
            command.Parameters[3].Value = ((int)(id_contactBankAccount));
            if ((OperationsStatus == null)) {
                throw new global::System.ArgumentNullException("OperationsStatus");
            }
            else {
                command.Parameters[4].Value = ((string)(OperationsStatus));
            }
            command.Parameters[5].Value = ((double)(Balance));
            global::System.Data.ConnectionState previousConnectionState = command.Connection.State;
            if (((command.Connection.State & global::System.Data.ConnectionState.Open) 
                        != global::System.Data.ConnectionState.Open)) {
                command.Connection.Open();
...
SELECT id_portfolio, Name, Status, Balance, OpeningDate, ClosingDate, id_client FROM InvestPortfolio WHERE (id_portfolio = @id_portfolio)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[1] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[1].Connection = this.Connection;
            this._commandCollection[1].CommandText = "INSERT INTO [dbo].[InvestPortfolio] ([Name], [Status], [Balance], [OpeningDate], " +
                "[ClosingDate], [id_client]) VALUES (@Name, @Status, @Balance, @OpeningDate, @Clo" +
                "singDate, @id_client);\r\n";
            this._commandCollection[1].CommandType = global::System.Data.CommandType.Text;
            ...
            this._commandCollection[2] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[2].Connection = this.Connection;
            this._commandCollection[2].CommandText = "UPDATE [dbo].[InvestPortfolio] SET [Status] = @Status, [ClosingDate] = @ClosingDa" +
                "te WHERE (([id_portfolio] = @Original_id_portfolio));\r\n";
            this._commandCollection[2].CommandType = global::System.Data.CommandType.Text;
            ...
            this._commandCollection[2].Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@ClosingDate", global::System.Data.SqlDbType.DateTime, 8, global::System.Data.ParameterDirection.Input, 0, 0, "ClosingDate", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
            this._commandCollection[2].Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@Original_id_portfolio", global::System.Data.SqlDbType.Int, 4, global::System.Data.ParameterDirection.Input, 0, 0, "id_portfolio", global::System.Data.DataRowVersion.Original, false, null, "", "", ""));
        }
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Insert, false)]
        public virtual int InsertQuery(string Name, string Status, double Balance, System.DateTime OpeningDate, global::System.Nullable<global::System.DateTime> ClosingDate, int id_client) {
            global::System.Data.SqlClient.SqlCommand command = this.CommandCollection[1];
            if ((Name == null)) {
                throw new global::System.ArgumentNullException("Name");
            }
            ...
            command.Parameters[3].Value = ((System.DateTime)(OpeningDate));
            if ((ClosingDate.HasValue == true)) {
                command.Parameters[4].Value = ((System.DateTime)(ClosingDate.Value));
            }
            else {
                command.Parameters[4].Value = global::System.DBNull.Value;
            }
            command.Parameters[5].Value = ((int)(id_client));
            global::System.Data.ConnectionState previousConnectionState = command.Connection.State;
            if (((command.Connection.State & global::System.Data.ConnectionState.Open) 
                        != global::System.Data.ConnectionState.Open)) {
                command.Connection.Open();
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, false)]
        public virtual int UpdateQuery(string Status, global::System.Nullable<global::System.DateTime> ClosingDate, int Original_id_portfolio) {
            global::System.Data.SqlClient.SqlCommand command = this.CommandCollection[2];
            if ((Status == null)) {
                throw new global::System.ArgumentNullException("Status");
            }
            ...
            if ((ClosingDate.HasValue == true)) {
                command.Parameters[1].Value = ((System.DateTime)(ClosingDate.Value));
            }
            else {
                command.Parameters[1].Value = global::System.DBNull.Value;
            }
            command.Parameters[2].Value = ((int)(Original_id_portfolio));
            global::System.Data.ConnectionState previousConnectionState = command.Connection.State;
            if (((command.Connection.State & global::System.Data.ConnectionState.Open) 
                        != global::System.Data.ConnectionState.Open)) {
                command.Connection.Open();
...
SELECT id_SharesXPortfolio, id_shares, id_portfolio FROM SharesXPortfolio WHERE (id_SharesXPortfolio = @id_SharesXPortfolio)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[1] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[1].Connection = this.Connection;
            this._commandCollection[1].CommandText = "INSERT INTO [dbo].[SharesXPortfolio] ([id_shares], [id_portfolio]) VALUES (@id_sh" +
                "ares, @id_portfolio);\r\n";
            this._commandCollection[1].CommandType = global::System.Data.CommandType.Text;
            this._commandCollection[1].Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@id_shares", global::System.Data.SqlDbType.Int, 4, global::System.Data.ParameterDirection.Input, 0, 0, "id_shares", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
            this._commandCollection[1].Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@id_portfolio", global::System.Data.SqlDbType.Int, 4, global::System.Data.ParameterDirection.Input, 0, 0, "id_portfolio", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
        }
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Insert, false)]
        public virtual int InsertQuery(int id_shares, int id_portfolio) {
            global::System.Data.SqlClient.SqlCommand command = this.CommandCollection[1];
            command.Parameters[0].Value = ((int)(id_shares));
            command.Parameters[1].Value = ((int)(id_portfolio));
            global::System.Data.ConnectionState previousConnectionState = command.Connection.State;
            if (((command.Connection.State & global::System.Data.ConnectionState.Open) 
                        != global::System.Data.ConnectionState.Open)) {
                command.Connection.Open();
